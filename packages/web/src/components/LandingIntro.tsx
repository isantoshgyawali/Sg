...
import fireball from "../images/fire.gif"
...
const LandingIntro = () => {
    return (
        <div className="flex flex-col">
            ...
            {/* fireball */}
            <div className="absolute self-center bg-white bottom-10 animate-moveDownFade -z-10">
                <img src={fireball} alt="Logo" className='h-56 ml-3 mix-blend-difference'/>
            </div>
        </div>
    )
}
